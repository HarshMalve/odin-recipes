// export var apiURL = "www.themealdb.com/api/json/v1/1/";

var mealDBAPI = {
    baseURL: "https://www.themealdb.com/api/json/v1/1/",
    api: {
        searchByName: 'search.php?s=',
        mealDetailsByID: 'lookup.php?i=',
        randomMeal: 'random.php',
        mealCategoriesList: 'list.php?c=list',
        filterByCategory: 'filter.php?c=',
        mealAreasList: 'list.php?a=list',
        filterByArea: 'filter.php?a=',
        mealIngredientsList: 'list.php?i=list',
